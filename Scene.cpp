...
glm::vec3 Scene::Transform::get_world_position() const{
	glm::vec4 v = make_local_to_world()*glm::vec4(position,1.f);
...
void Scene::render() {
	...
	for (auto const &object : objects) {
		...
		glUniform1i(program_PlayerIdx,object.playerIdx);
